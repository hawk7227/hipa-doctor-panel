...
// ═══════════════════════════════════════════════════════════════
type OverlayThemeName = 'purple' | 'cyan' | 'emerald' | 'amber' | 'rose' | 'blue' | 'slate' | 'teal' | 'red' | 'orange'
const OVERLAY_THEMES: Record<OverlayThemeName, { gradient: string; border: string; dot: string }> = {
  ...
  red:     { gradient: 'from-red-950/95 via-slate-900/95 to-red-900/90',         border: 'border-red-500/30',     dot: 'bg-red-500'     },
  orange:  { gradient: 'from-orange-950/95 via-slate-900/95 to-orange-900/90',   border: 'border-orange-500/30',  dot: 'bg-orange-500'  },
}
