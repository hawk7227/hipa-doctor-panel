...
export default function BugsyRecordingScreen({ onStop, context }: BugsyRecordingScreenProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 min-h-[400px]">
      ...
      <div className="text-center mb-6"><p className="text-lg text-white font-medium">{isPaused ? 'Paused' : 'Recording...'}</p><p className="text-sm text-gray-400">{isPaused ? 'Resume to continue' : 'Click, draw, and talk to show the bug'}</p></div>
