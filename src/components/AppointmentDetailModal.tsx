          ...
          <div className="sticky top-0 bg-slate-900/95 backdrop-blur-md border-b border-white/10 z-10 flex-shrink-0 px-4 py-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                {/* Open Video Consultation — fixed in header, not draggable */}
                {!layout.isCustomizeMode && appointment && (appointment as any).dailyco_meeting_url && (
                  <button onClick={() => setShowVideoPanel(true)}
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold whitespace-nowrap transition-all text-white border-0"
