...
export default function AppointmentDetailModal({ 
  ...
  return (
    <>
      ...
      {/* Main container — sits to the right of the existing app sidebar */}
      <div className="fixed top-0 right-0 h-full z-50" style={{ left: 'var(--sidebar-width, 240px)' }}>
        {/* Panel */}
        <div className={`h-full bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-l border-white/20 shadow-2xl transform transition-transform duration-300 ${
