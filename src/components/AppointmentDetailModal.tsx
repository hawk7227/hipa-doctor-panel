...
export default function AppointmentDetailModal({ 
  ...
  useEffect(() => {
    if (appointment?.chart_locked !== undefined) {
      setChartLocked(!!appointment.chart_locked)
    }
  ...
  const renderSection = useCallback(
    (sectionId: string, panel: 'left' | 'right') => {
      ...
      switch (sectionId) {
        ...
        case 'lab-results':
          return (
            <LabResultsSection key={sectionId} labResults={labResults.labResults} isLoadingLabs={labResults.isLoadingLabs} isCustomizeMode={layout.isCustomizeMode} sectionProps={sectionProps} onLoadLabResults={labResults.loadLabResults} patientId={appointment?.patient_id} appointmentId={appointmentId || undefined} />
          )
