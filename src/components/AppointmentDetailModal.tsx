        ...
        case 'meeting-info':
          return (
            <div key={sectionId} {...sectionProps}>
              ...
              {/* ─── Freed AI Scribe Panel (below video, scrollable) ─── */}
              {!layout.isCustomizeMode && (
                <div className="mt-3 rounded-xl border border-emerald-500/20 overflow-hidden" style={{ background: 'linear-gradient(180deg, #0a1a14, #0d1117)' }}>
                  {/* Freed header bar */}
                  <div className="flex items-center justify-between px-3 py-2 border-b border-emerald-500/20" style={{ background: 'rgba(16,185,129,0.08)' }}>
                  ...
                  {/* SOAP Notes preview — doctor scrolls to see */}
                  <div className="p-4 border-b border-white/5">
