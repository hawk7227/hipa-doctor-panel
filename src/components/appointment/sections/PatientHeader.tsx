      ...
      <div className="px-4 sm:px-6 py-4 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-2xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          ...
          <div className="sm:col-span-2 lg:col-span-3">
            ...
            {/* Intake Form Answers - Always show if available */}
            {(appointment?.patients?.has_drug_allergies !== undefined || 
              appointment?.patients?.has_ongoing_medical_issues !== undefined || 
              appointment?.patients?.has_recent_surgeries !== undefined ||
              appointment?.has_drug_allergies !== undefined || 
              appointment?.has_ongoing_medical_issues !== undefined || 
              appointment?.has_recent_surgeries !== undefined) && (
