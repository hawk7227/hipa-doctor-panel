      ...
      <div className="px-4 sm:px-6 py-4 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-2xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          ...
          <div className="sm:col-span-2 lg:col-span-3">
            ...
            {/* Intake Form Answers - Only show if patient has actually completed intake */}
            {/* CRITICAL: Supabase returns null for unset columns, and null !== undefined is true,
                so we must check for actual boolean values (true/false), not just !== undefined */}
