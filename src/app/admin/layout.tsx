...
import {
  ...
  ChevronLeft, ChevronRight, LogOut, ClipboardList, Calendar, BarChart3, Database, Megaphone, Radio
} from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { href: '/admin/command-center', label: 'Command Center', icon: Radio, badgeKey: '' },
