...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    console.log(`[allergies] patient=${patient_id} local=${local?.length||0}`)
...
// Updated: 2026-02-20 | Removed DrChrono integration (drchrono_allergies queries, getDrchronoPatientId, export fallback)
//
