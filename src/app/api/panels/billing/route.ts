...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    console.log(`[billing] patient=${patient_id} claims=${claims?.length||0}`)
...
// Updated: 2026-02-20 | Removed DrChrono integration (drchrono_line_items queries, getDrchronoPatientId)
//
