...
Change 2 — Persist selected appointment in URL (around line 101):
...
Click an appointment → URL becomes /doctor/appointments?apt=abc123
Close the chart → URL goes back to /doctor/appointments
Refresh while chart is open → ?apt=abc123 is still in the URL, so the chart reopens automatically
No other code touched. Deploy and test!
