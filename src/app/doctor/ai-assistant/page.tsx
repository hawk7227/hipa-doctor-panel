  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#0d2626] rounded-lg border border-[#1a3d3d] p-6">
        ...
        <p className="text-gray-400 mt-2">Get AI-powered assistance for diagnoses, treatments, and note summaries</p>
      </div>

      {/* Interaction Type Selector */}
      <div className="bg-[#0d2626] rounded-lg border border-[#1a3d3d] p-6">
        <h2 className="text-lg font-semibold text-white mb-4">Interaction Type</h2>
      ...
      <div className="bg-[#0d2626] rounded-lg border border-[#1a3d3d]">
            ...
            messages.map((message) => (
              <div key={message.id} className="space-y-2">
                ...
                <div className="flex justify-start">
                  <div className="bg-gray-100 text-gray-900 rounded-lg p-3 max-w-xs lg:max-w-md">
        ...
        {/* Input */}
        <div className="p-6 border-t border-[#1a3d3d]">
          <div className="flex space-x-4">
            <textarea
