...
export default function DoctorAppointments() {
  ...
  useEffect(() => {
    const colors = ['#00D4AA', '#00f5ff', '#ff00ff', '#ffff00', '#ff6b6b', '#4ecdc4', '#45b7d1', '#96ceb4', '#ff0080', '#00ffcc']
  ...
  useEffect(() => {
    if (!loading && !celebrationTriggeredRef.current) {
      ...
      const confettiColors = ['#ff0000', '#00ff00', '#0000ff', '#ffff00', '#ff00ff', '#00ffff', '#ff6600', '#9933ff', '#00D4AA', '#ff0080']
