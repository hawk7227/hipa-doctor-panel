  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0B0F14] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        {/* Login Method Toggle */}
        <div className="bg-[#111820] rounded-lg p-1 flex gap-1">
          <button
            onClick={() => {
            ...
            className={`flex-1 py-2 px-4 rounded-md font-medium transition-all duration-200 ${
              loginMethod === 'password'
                ? 'bg-red-600 text-[#E8ECF1] shadow-md'
                : 'text-[#E8ECF1] hover:text-[#E8ECF1]'
            }`}
          >
            Password
          </button>
        ...
        {loginMethod === 'password' && (
          <form className="mt-8 space-y-6" onSubmit={handlePasswordLogin}>
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-[#E8ECF1] mb-2">
                Password
              </label>
          ...
          <div className="mt-8 space-y-6">
            {!otpSent ? (
              <form onSubmit={handleSendOTP} className="space-y-6">
                <div>
                  <label htmlFor="email-otp" className="block text-sm font-medium text-[#E8ECF1] mb-2">
                    Email address
                  </label>
                  <input
                    id="email-otp"
        ...
        <div className="text-center">
          <p className="mt-2 text-sm text-[#E8ECF1]">
            New doctor?{' '}
